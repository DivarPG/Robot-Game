...
import game.model.field.core.SelfActivatingObject;
 ...
 * Ячейка точки выхода.
 */
public class ExitPoint extends SelfActivatingObject {

    //region ДЕЙСТВИЯ


    @Override
    public void execute(CellObject object) {
     ...
     */
    private void teleportRobot(CellObject object) {
